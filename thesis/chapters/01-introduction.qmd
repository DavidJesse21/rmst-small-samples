...
For instance, in oncology trials the comparison of treatments with different effect mechanisms often results in patterns in which the survival curves separate only after some delay time or cross each other at some point in time [@bardo2023].
