...
Also in these scenarios it would be desirable to have valid statistical methods at hand that make less assumptions and yield interpretable results.
...
The first of these two approaches employs an asymptotic test for conducting inference based on pseudo-observation regression models using a HC3 covariance matrix estimator.
With the second approach we try to refine this method by replacing the asymptotic test with a bootstrap hypothesis test.
