...
Obviously, @fig-nph depicts theoretical scenarios only that might be considered idealized to some extent.
...
Although the hazard ratio fluctuates a little bit in the initial phase of the study, it remains within a relatively small range overall, not deviating much from the fixed hazard ratio obtained from the Cox model.
