...
For a given $t^*$, this leads to the specification of the following pair of hypotheses:
$$
...
When comparing it to the studentized permutation method presented in @sec-studperm it may, however, be considered inferior apart from its flexibility to adapt it to situations beyond the testing problem (@eq-test-problem).
...
Nonetheless, the basic idea is still similar to that of the studentized permutation test:
