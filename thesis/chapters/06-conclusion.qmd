...
We further focussed on procedures for which the effect measure and the statistical test are aligned with each other.
...
For the asymptotic pseudo-observations method this was due to a slightly too liberal behaviour in settings with very small sample sizes, whereas the bootstrap approach was a little too conservative in these scenarios.
...
The same holds true for the pseudo-observations methods presented in this thesis and might even be considered more straightforward as existing software solutions can be applied.

Casting estimation and testing problems for the RMST into the framework of generalized linear models makes the pseudo-observations approaches attractive alternatives that should be considered further, both by practicioners and by methodological researchers in statistics.
...
The demonstration on real-world data sets in @sec-examples already gave a flavour of this idea.
...
Especially for situations with small sample sizes as considered in this thesis, this might lead to small subgroups and therefore imprecise and variable effect estimates.
These thoughts could be investigated in more detail and be systematically evaluated in future research.
...
One particular methodh we think of is the wild bootstrap [@liu1988].
...
Lastly, we note that @munko2023 considered extensions of RMST-based tests to settings with more than two populations.
