...
The purpose is to get an impression of how the usage of IJ pseudo-observations instead of ordinary ones impacts the behavior the tesing procedure.
...
#| tbl-cap: "Type-I error rates in % (nominal level $\\alpha = 5\\%$) of asymptotic tests using ordinary and infinitesimal jackknife pseudo-observations"
...
#| fig-cap: "Coverage in % (nominal level $\\alpha = 5\\%$) of asymptotic tests using ordinary and infinitesimal jackknife pseudo-observations"
#| fig-width: 10
#| fig-height: 10
